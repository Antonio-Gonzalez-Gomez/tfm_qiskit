...
nQubits = 100       #Numero de qubits transmitidos
nSeguridad = 10     #Qubits reservados para seguridad
ataqueEve = False   #Activar un ataque de Eve
######################
...
for i in range(nQubits):
    ...
    #Si se produce un ataque, Eve mide los qubits y los reenvía
    if (ataqueEve):
        if (basesEve[i] == 1):
            qc.h(0)
            qc.measure_all()
...
#En caso contrario, el protocolo se ha completado
if claveValida:
